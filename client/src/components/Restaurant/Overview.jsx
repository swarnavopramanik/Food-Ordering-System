  ...
  const [reviews, setReviews] = useState([
    {
      ...
      createdAt: "Mon Oct 17 2022 00:29:51 GMT+0530 (India Standard Time)",
    ...
    <div className="flex flex-col gap-5 md:flex-row relative">
        ...
        <div className="flex flex-col-reverse">
          ...
          <div className="my-4 w-full md:hidden flex flex-col gap-4">
            <MapView
              title="McDonald's"
              phno="+919007994029"
              mapLocation={getLatLong("22.551447568479922, 88.34619029848368")}
              address= "20K, Park Street Area, Kolkata"
            />
          </div>
        </div>
      </div>
      ...
      >
        <MapView
          ...
          phno="+919007994029"
          mapLocation={getLatLong("22.551447568479922, 88.34619029848368")}
          latAndLong={"22.551447568479922, 88.34619029848368"}
          address= "20K, Park Street Area, Kolkata"
        />
      </aside>
    </div>
